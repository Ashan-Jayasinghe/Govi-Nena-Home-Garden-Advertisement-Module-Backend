...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
 ...
 $stmt->bind_param("sssissiis", $category, $subcategory, $title, $stock, $address, $mobile, $acceptTerms,$user_id,$description);
    ...
    $pgr_stmt->bind_param("isdsss", $advertisement_id, $type, $applicationRatio, $price1L, $price5L, $price10L);
    ...
    // Success response
    echo json_encode(array('status' => 'success', 'message' => 'PGR advertisement successfully submitted'));
    exit;
}
